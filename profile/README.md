...
- **[madcore-web](https://github.com/themadorg/madcore-web)** `work-in-progress` — javascript library for building fully working web chat clients on the chatmail protocol. [[releases](https://github.com/themadorg/madcore-sdk/releases)]

### 🛠 management

- **[madmail-admin-web](https://github.com/themadorg/madmail-admin-web)** — web dashboard for managing madmail instances. [[releases](https://github.com/themadorg/madmail-admin-web/releases)] | [admin.madmail.chat](https://admin.madmail.chat)

### 📚 documentation

- **[deltachat-wiki](https://github.com/themadorg/deltachat-wiki)** — wiki and docs for the delta chat ecosystem. [[releases](https://github.com/themadorg/deltachat-wiki/releases)] | [deltachat.wiki](https://deltachat.wiki)
